    ...
    Dir.foreach(root_dir) do |subdir|
      ...
      Dir.foreach(subdir_path) do |file|
        ...
        File.open(file_path) do |f|
          ...
          p contents.match(app_time_aggregate_regex)
          ...
          csv << [subdir.to_s[1], app_time_aggregate,
                   mpi_time_aggregate, mpi_time_aggregate_percentage]
        end
      end
    end
  end
